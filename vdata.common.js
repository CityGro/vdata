...
function customDefaultsAssignIn$1(objValue, srcValue, key, object) {
  if (objValue === undefined ||
      (eq$4(objValue, objectProto$10[key]) && !hasOwnProperty$8.call(object, key))) {
    return srcValue;
  }
  return objValue;
}
...
function isString$1(value) {
  return typeof value == 'string' ||
    (!isArray$5(value) && isObjectLike$5(value) && baseGetTag$5(value) == stringTag$1);
}
...
var main_2 = main.AsyncDataMixin;
    ...
    install: function install(Vue, options) {
      ...
      Vue.mixin({
        ...
        beforeCreate: function beforeCreate() {
          ...
          if (hasVdata(this)) {
            var self = this;
            this._vdataHandler = function (event) {
...
/* Built-in method references that are verified to be native. */
var WeakMap$1 = getNative$4(root$4, 'WeakMap');
...
function lodash$1(value) {
  if (isObjectLike$6(value) && !isArray$6(value) && !(value instanceof LazyWrapper$2)) {
...
function createWrap$1(func, bitmask, thisArg, partials, holders, argPos, ary, arity) {
  ...
  ary = ary === undefined ? ary : nativeMax$2(toInteger$2(ary), 0);
...
function baseIsEqualDeep$1(object, other, bitmask, customizer, equalFunc, stack) {
  var objIsArr = isArray$10(object),
      othIsArr = isArray$10(other),
...
function isFlattenable$1(value) {
  return isArray$12(value) || isArguments$3(value) ||
 ...
 */
var toPairs$2 = createToPairs(keys$6);
...
var toKV = flow(entries, flatten$2);
